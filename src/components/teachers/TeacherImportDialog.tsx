...
import { useTeacherImport, TEACHER_IMPORT_COLUMNS } from "@/hooks/useTeacherImport";
import type { ImportResult } from "@/hooks/useTeacherImport";
...
export function TeacherImportDialog({ open, onOpenChange }: TeacherImportDialogProps) {
  const [step, setStep] = useState<ImportStep>("upload");
  const [dragActive, setDragActive] = useState(false);
  const [selectedFile, setSelectedFile] = useState<File | null>(null);
  const [importResult, setImportResult] = useState<ImportResult | null>(null);

  const { importTeachers, progress, downloadCsvTemplate, downloadExcelTemplate } = useTeacherImport();
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="space-y-6 overflow-y-auto pr-2">
            ...
            <div className="space-y-3 rounded-lg border bg-muted/30 p-4">
              ...
              <ol className="text-xs text-muted-foreground space-y-1 list-decimal list-inside">
                ...
                <li>Fill in one teacher per row. Do not rename column headers.</li>
                ...
                <li>Employee numbers and national IDs must be unique across the file and the system.</li>
        ...
        {step === "processing" && (
          <div className="py-12 space-y-6">
            <div className="text-center space-y-4">
              ...
              <div>
                <p className="font-medium">Importing teachers...</p>
        ...
        {step === "results" && importResult && (
          <div className="space-y-6 flex-1 overflow-hidden flex flex-col">
                      ...
                      {importResult.errors.map((error, idx) => (
                        <TableRow key={idx}>
                          ...
                          <TableCell className="text-sm">
                            {error.data?.full_name || error.data?.employee_number || "-"}
                          </TableCell>
            ...
            <div className="flex justify-end gap-2">
              <Button variant="outline" onClick={handleStartOver}>Import More</Button>
